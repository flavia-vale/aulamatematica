...
1. **Interpretar enunciado longo em português** — porque metade das questões é texto
2. **Identificar qual conteúdo cobrar** — porque o enunciado raramente diz "isso é função de 2º grau"
3. **Aplicar o conteúdo** — que é a parte "matemática" propriamente
...
1. Fazer **um simulado completo de matemática por semana** (45 questões, 3 horas, com pressão real de tempo)
2. **Revisar erros** em detalhe — onde travou? interpretação? conteúdo? cálculo?
3. **Treinar estratégia de prova**: começar pelas mais fáceis, marcar as difíceis pra voltar depois, manejar o tempo
